...
class Source(Base):
    ...
    dedup_policy: Mapped[str] = mapped_column(String(50), default="source_video_id")
    retry_max_attempts: Mapped[int] = mapped_column(Integer, default=2)
    retry_backoff_minutes: Mapped[int] = mapped_column(Integer, default=10)
    retry_backoff_multiplier: Mapped[int] = mapped_column(Integer, default=2)
