...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("video_item_id", sa.Integer(), nullable=False, unique=True),
        sa.Column("title", sa.String(length=500), nullable=False, server_default=""),
        sa.Column("ai_title", sa.String(length=500), nullable=False, server_default=""),
        sa.Column("ai_video_category", sa.String(length=120), nullable=False, server_default=""),
        sa.Column("ai_quality_score", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("ai_quality_report", sa.Text(), nullable=False, server_default=""),
